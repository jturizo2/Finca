...
//Ruta de carga fija - Hacerla dinamica
    ...
    public void cerrar(View view) {
        ...
        File dir2 =crearDirectorioPublico("Datos"); //Metodo para crer la ruta de almacenamiento del  backup
        String NameFile1 = "Medicamentos.csv";
        String NameFile8 = "jo.csv";
        String NameFile11 = "Leche.csv";
        String NameFile2 = "Ventas.csv";
        ...
        String NameFile5 = "Propietarios.csv";
        String NameFile6 = "Hierro.csv";
        String filePath6 = dir2.toString() + File.separator +"/"+ NameFile1;
        String filePath88 = dir2.toString() + File.separator +"/"+ NameFile8;
        String filePath99 = dir2.toString() + File.separator +"/"+ NameFile11;
        String filePath11 = dir2.toString() + File.separator +"/"+ NameFile2;
        String filePath22 = dir2.toString() + File.separator +"/"+ NameFile3;
        String filePath33 = dir2.toString() + File.separator +"/"+ NameFile4;
        String filePath44 = dir2.toString() + File.separator +"/"+ NameFile5;
        String filePath55 = dir2.toString() + File.separator +"/"+ NameFile6;
...
//------------------------------------------------------------------------------------------------
        ...
        StorageReference storageRef = storage.getReference();
        //Hierro
        Uri file = Uri.fromFile(new File(filePath6));
        StorageReference riversRef =  storageRef.child(us+"/"+file.getLastPathSegment());
        UploadTask uploadTask1 = riversRef.putFile(file);
        //Medicamentos

        file = Uri.fromFile(new File(filePath88));
        riversRef =  storageRef.child(us+"/"+file.getLastPathSegment());
        UploadTask uploadTask2 = riversRef.putFile(file);


        file = Uri.fromFile(new File(filePath99));
        riversRef =  storageRef.child(us+"/"+file.getLastPathSegment());
        UploadTask uploadTask3 = riversRef.putFile(file);

        file = Uri.fromFile(new File(filePath11));
        riversRef =  storageRef.child(us+"/"+file.getLastPathSegment());
        UploadTask  uploadTask4 = riversRef.putFile(file);

        file = Uri.fromFile(new File(filePath22));
        riversRef =  storageRef.child(us+"/"+file.getLastPathSegment());
        UploadTask  uploadTask5 = riversRef.putFile(file);

        file = Uri.fromFile(new File(filePath33));
        riversRef =  storageRef.child(us+"/"+file.getLastPathSegment());
        UploadTask  uploadTask6 = riversRef.putFile(file);

        file = Uri.fromFile(new File(filePath44));
        riversRef =  storageRef.child(us+"/"+file.getLastPathSegment());
        UploadTask  uploadTask7 = riversRef.putFile(file);

        file = Uri.fromFile(new File(filePath55));
        riversRef =  storageRef.child(us+"/"+file.getLastPathSegment());
